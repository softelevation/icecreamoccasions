...
function nf_setup_grid(grid){
				...
				grid.find('.grid_input_holder'+grid_parent_class_pre).each(
					function(index)
						...
						grid_width = grid_width.replace('col-mb-','');
						...
						grid.prepend('<div class="grid-width-slider grid-'+ index +'" data-grid-target="'+ index +'" data-grid-width="'+ set_grid_width +'" data-col-class="'+ col_bs_class +'"></div>');
