...
//GET STAR RATING SETTINGS
	...
	//GET TOTAL STARS	
		...
		jQuery(".rating-on-icon-text-color").trigger("colorpickersliders.updateColor", (current_field.find('#star').attr('data-styleon')) ? current_field.find('#star').attr('data-styleon') : '#ec971f');
		jQuery(".rating-off-icon-text-color").trigger("colorpickersliders.updateColor",(current_field.find('#star').attr('data-styleoff')) ? current_field.find('#star').attr('data-styleoff') : '#bbb');
		jQuery(".rating-half-icon-text-color").trigger("colorpickersliders.updateColor", (current_field.find('#star').attr('data-stylehalf')) ? current_field.find('#star').attr('data-stylehalf') : '#ec971f');
...
//GET IMAGE SELECTION  SETTINGS
	if(current_field.hasClass('image-choices-field'))
		{
		//jQuery(".thumb-wrapper-color").trigger("colorpickersliders.updateColor", current_field.find('.image-choices-choice label.radio-inline').css('background-color'));		
		//jQuery(".thumb-border-color").trigger("colorpickersliders.updateColor", current_field.find('.image-choices-choice label.radio-inline').css('border-color'));		

		jQuery(".image-wrapper-color").trigger("colorpickersliders.updateColor", current_field.find('.image-choices-choice-image-wrap').css('background-color'));		
		jQuery(".image-border-color").trigger("colorpickersliders.updateColor", current_field.find('.image-choices-choice-image-wrap').css('border-color'));		
		
		jQuery(".label-wrapper-color").trigger("colorpickersliders.updateColor", current_field.find('.image-choices-choice .image-choices-choice-text').css('background-color'));		
		jQuery(".label-border-color").trigger("colorpickersliders.updateColor", current_field.find('.image-choices-choice .image-choices-choice-text').css('border-color'));		
...
if(current_field.hasClass('html_fields'))	
	jQuery(".input-bg-color").trigger("colorpickersliders.updateColor", current_field.find('#field_container').css('background-color'));
else
			...
			if(strstr(target,'data'))
				...
				if(css)	
					...
					if(current_field.hasClass('html_fields') && css=='background-color')
						current_field.find('#field_container').css(css,'rgba('+color.rgba.r+','+color.rgba.g+','+color.rgba.b+','+color.rgba.a+')')
					else
...
//GET BACKGOUND POSITION	
	...
	jQuery(".wrapper-bg-color").trigger("colorpickersliders.updateColor", get_target.css('background-color'));
	...
	var form_border_radius = (jQuery('.ui-nex-forms-container').css('border-top-right-radius')) ? jQuery('.ui-nex-forms-container').css('border-top-right-radius') : '4';
