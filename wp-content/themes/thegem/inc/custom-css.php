...
<?php if(thegem_get_option('top_area_disable_tablet')) : ?>
...
<?php if(thegem_get_option('xlarge_custom_responsive_fonts')) : ?>
...
.page-title-excerpt,
.custom-title-excerpt {
	font-weight: <?php echo str_replace(array('italic', 'regular'),array('', 'normal'),thegem_get_option('title_excerpt_font_style')); ?>;
}
...
.wpb-js-composer .vc_tta.vc_tta-accordion.vc_tta-style-modern .vc_tta-panel .vc_tta-panel-title,
.wpb-js-composer .vc_tta.vc_tta-accordion.vc_tta-style-simple_dashed .vc_tta-panel .vc_tta-panel-title {
	font-weight: <?php echo str_replace(array('italic', 'regular'),array('', 'normal'),thegem_get_option('tabs_title_font_style')); ?>;
}
...
<?php if(thegem_get_option('tabs_line_height')) : ?>
.wpb-js-composer .vc_tta.vc_tta-tabs .vc_tta-tab.vc_active > a,
.wpb-js-composer .vc_tta.vc_tta-tabs.vc_tta-style-outline .vc_tta-tab a,
.wpb-js-composer .vc_tta.vc_tta-tabs.vc_tta-style-modern .vc_tta-tab a,
.wpb-js-composer .vc_tta.vc_tta-tabs .vc_tta-panel.vc_active .vc_tta-panel-title,
...
.wpb-js-composer .vc_tta.vc_tta-accordion.vc_tta-style-modern .vc_tta-panel .vc_tta-panel-title,
.wpb-js-composer .vc_tta.vc_tta-accordion.vc_tta-style-simple_dashed .vc_tta-panel .vc_tta-panel-title {
	line-height: <?php echo thegem_get_option('tabs_line_height'); ?>px;
}
<?php endif; ?>
...
.wpb-js-composer .vc_tta.vc_tta-tabs .vc_tta-panel .vc_tta-panel-title,
.wpb-js-composer .vc_tta.vc_tta-accordion .vc_tta-panel .vc_tta-panel-title {
	font-weight: <?php echo str_replace(array('italic', 'regular'),array('', 'normal'),thegem_get_option('tabs_title_thin_font_style')); ?>;
}
...
#footer-menu li + li:before {
	border-left-color: <?php echo thegem_get_option('footer_menu_separator_color'); ?>;
