						...
						<div class="page-scroller-setting-box" style="display: none">
							...
							<div class="page-scroller-setting-advanced-box">
								...
								<div class="page-scroller-style-dots-box" style="margin-top: 10px">
									...
									<?php thegem_print_select_input(thegem_get_page_scroller_dots_styles(), $page_data['fullpage_style_dots'], 'thegem_page_data[fullpage_style_dots]', 'fullpage_style_dots'); ?><br />
								</div><br />
								...
								<input name="thegem_page_data[fullpage_fixed_background]" type="checkbox" id="fullpage_fixed_background" value="1" <?php checked($page_data['fullpage_fixed_background'], 1); ?> />
								<label for="fullpage_fixed_background"><?php esc_html_e('Enable Fixed Backgrounds', 'thegem'); ?></label><br /><br />
...
function thegem_get_page_scroller_dots_styles() {
	return array(
...
function thegem_get_sanitize_page_effects_data($post_id = 0, $item_data = array(), $type = false) {
	...
	$page_data['fullpage_style_dots'] = thegem_check_array_value(array_keys(thegem_get_page_scroller_dots_styles()), $page_data['fullpage_style_dots'], 'outline');
	$page_data['fullpage_disabled_tooltips_dots'] = $page_data['fullpage_disabled_tooltips_dots'] ? 1 : 0;
	$page_data['fullpage_fixed_background'] = $page_data['fullpage_fixed_background'] ? 1 : 0;
