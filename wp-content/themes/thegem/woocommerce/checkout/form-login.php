...
<?php
	...
	if ($thegem_checkout_type == 'one-page') {
		$info_message = apply_filters( 'woocommerce_checkout_login_message', esc_html__( 'Returning customer?', 'woocommerce' ) . ' <a href="#" class="checkout-show-login-popup">' . esc_html__( 'Click here to login', 'woocommerce' ) . '</a>' );
