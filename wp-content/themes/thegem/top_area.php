			...
			<?php if(has_nav_menu('top_area') || thegem_get_option('top_area_button_text')) : ?>
				<div class="top-area-block top-area-menu">
					...
					<?php if(thegem_get_option('top_area_button_text')) : ?>
						<div class="top-area-button"><?php thegem_button(array('href' => thegem_get_option('top_area_button_link'), 'text' => stripslashes(thegem_get_option('top_area_button_text')), 'size' => 'tiny', 'no-uppercase' => true), true); ?></div>
					<?php endif; ?>
				</div>
			<?php endif; ?>
		</div>
