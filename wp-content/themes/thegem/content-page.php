...
if ($thegem_page_effects['effects_page_scroller']) {
    ...
    if ($thegem_page_effects['effects_page_scroller_type'] == 'basic') {
        wp_enqueue_script('thegem-page-scroller');
    } else {
        if (thegem_is_plugin_active('js_composer/js_composer.php') && !vc_is_page_editable()) {
            $fullpage_enabled = true;
            thegem_enqueue_fullpage();
        }
    }
...
if ($thegem_page_effects['effects_no_bottom_margin']) {
	$thegem_no_margins_block .= ' no-bottom-margin';
}
if ($thegem_page_effects['effects_no_top_margin']) {
							...
							<div class="post-meta date-color">
								<div class="entry-meta single-post-meta clearfix gem-post-date">
									<div class="post-meta-right">
										...
										<?php endif; ?>
										<?php if (comments_open() && !thegem_get_option('blog_hide_comments') && function_exists('zilla_likes') && !thegem_get_option('blog_hide_likes')): ?>
											<span class="sep"></span><?php endif; ?>
										<?php if (function_exists('zilla_likes') && !thegem_get_option('blog_hide_likes')) {
											$print_block = true;
									...
									<div class="post-meta-left">
										...
										<?php if ($thegem_categories && !thegem_get_option('blog_hide_categories')) : $print_block = true; ?>
											<?php if (!thegem_get_option('blog_hide_author')): ?><span
										...
										<?php if (!thegem_get_option('blog_hide_date')) : $print_block = true; ?>
											<?php if (!thegem_get_option('blog_hide_author') || $thegem_categories && !thegem_get_option('blog_hide_categories')) : ?>
								...
								<div class="entry-meta single-post-meta clearfix gem-post-date">
									...
									<div class="post-meta-left">
										...
										<?php if (function_exists('zilla_likes') && !thegem_get_option('portfolio_hide_likes')) {
											if (!thegem_get_option('portfolio_hide_date') || $thegem_categories && !thegem_get_option('portfolio_hide_sets')): ?><span
